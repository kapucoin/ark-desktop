...
describe('transactionBuilderService',() => {
  ...
  const from = {
    username: "blog.guide",
    address: "K8McNcgSqtb7V6ccZfcEmyBFLzXvyQs12Q",
    masterpassphrase: "hundred clerk magic myself radar body north change elegant scorpion shoot dilemma",
    secondpassphrase: "hundred clerk magic myself radar body north change elegant scorpion shoot dilemma",
    balance: 600000000
  }

  const to = {
    address: "KPtmKCig63h9cKeZSxrKLNWQeCL947GGXa",
    publicKey: "03fee25affd221237cc4cb6fd11565fb425d46c34e2024cfb02e23c874ef33a646"
  }
  ...
  beforeEach(() => {
    module("arkclient.accounts", $provide => {
      ...
      networkServiceMock = { listenNetworkHeight: sinon.stub(),
                          ...
                          getNetwork: sinon.stub().returns({ version: 0x2D, token: tokenName })
                        }
